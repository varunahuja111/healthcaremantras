    ...
    <article>
      ...
      <footer>
        <ul class="nospace inline pushright">
          ...
          <li><a class="btn inverse" href="about.php">ABOUT US</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-80">
      <h6 class="heading"></h6>
      <p class="heading font-x3" id="1">Best Hospitals in Delhi</p>
    ...
    <div class="group">
      <div  style="padding-left:90px; margin-right:50px;">
        ...
        <ul class="nospace btmspace-30 linklist contact">
          ...
          <li><i class="fa fa-phone"></i> (+91) 88 00 630680</li>
          <li><i class="fa fa-fax"></i> (+91) 85 27 617675</li>
          <li><i class="fa fa-envelope-o"></i> healthcaremantras@gmail.com</li>
      </ul>
      </div>
      <!--<div class="one_third">
