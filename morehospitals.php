...
<li>
<a href="map.php">Hospital's Map</a>
</li>
<li>  
...
<div style="margin:20px 80px; background-color:#f2f2f2; ">	
	...
	<p><a href="moreabout.php?a=<?php echo $row['address']; ?>">READ MORE</a></p>
	<?php $name=$row['name']; ?>
	<footer style="padding:50px 10px 50px 500px;"><a href="patient.php?b=<?php echo $name;?>"><button type="submit" name="bookappointment" id="foot">BOOK AN APPOINTMENT</button></a></footer>
	</div>
	
	<div>
	<img src="<?php echo $row['image']; ?>" height="320" width="320" style="padding-right:50px;"></img>
	</div>
