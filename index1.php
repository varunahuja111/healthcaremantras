...
<div class="bgded overlay" style="background-image:url('http://barusahib.org/wp-content/uploads/layerslider/home-page-slider/Backround.jpg'); background-attachment:fixed;"> 
    ...
    <article>
      ...
      <footer>
        <ul class="nospace inline pushright">
          <li><a class="btn inverse" href="#">Hospitals</a></li>
          <li><a class="btn inverse" href="#">Medical Stores</a></li>
		  <li><a class="btn inverse" href="#">Labs</a></li>
        </ul>
      </footer>
    </article>
    <!-- ################################################################################################ -->
  ...
  <div class="wrapper row0">
    <div id="topbar" class="hoc clear"> 
      ...
      <div class="fl_left">
        <ul>
          <li><i class="fa fa-phone"></i> +91 9999999999</li>
          <li><i class="fa fa-envelope-o"></i> info@domain.com</li>
          <li><i class="fa fa-chrome"></i> www.healthcaremantras.com</li>
        </ul>
      </div>
      <div class="fl_right">
        <ul>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-80">
      <h6 class="heading"></h6>
      <p class="heading font-x3">Best Hospitals in India</p>
      <p>If you want others to be happy, practice compassion.  If you want to be happy, practice compassion</p>
    </div>
	
	
	<?php
	$sql="select * from hospitals where priority "
	?>
	
	
    <ul class="nospace group element btmspace-80">
      <li class="one_quarter first">
        <article><img src="Hospitals\Fortis Escorts Heart Institute.jpg" alt="" >
          <div class="txtwrap">
            <h6 class="heading">Fortis Escorts Heart Institute</h6>
      ...
      <li class="one_quarter">
        <article><img src="Hospitals\INDRAPRASTHA APOLLO HOSPITAL.jpg" alt="">
          <div class="txtwrap">
            <h6 class="heading">Indraprastha Apollo Hospital</h6>
      ...
      <li class="one_quarter">
        <article><img src="Hospitals\max super speciality hospital.jpg" alt="">
          <div class="txtwrap">
            <h6 class="heading">Max Superspeciality Hospital</h6>
            <p>1,2, Press Enclave Road, Mandir Marg, Saket, New Delhi, Delhi 110017</p>
            <footer><a href="#">Read More</a></footer>
          </div>
        </article>
      </li>
      <li class="one_quarter">
        <article><img src="Hospitals\ARTEMIS HOSPITAL.jpg" alt="">
          <div class="txtwrap">
            <h6 class="heading">Artemis Hospital</h6>
            <p>Sector 51, Gurugram, Haryana 122001</p>
            <footer><a href="#">Read More</a></footer>
          </div>
        </article>
      </li>
    </ul>
    <footer class="center"><a class="btn" href="#">FEW MORE HERE</a></footer>
    <!-- ################################################################################################ -->
    <!-- / main body -->
    <div class="clear"></div>
  </main>
...
<div class="wrapper row4 bgded overlay" style="background-image:url('http://www.digitalsignage.net/wp-content/uploads/2013/10/Healthcare-sized.jpg'); background-attachment:fixed;">
  <footer id="footer" class="hoc clear"> 
	...
	<img src="http://hmmagazine.s3.amazonaws.com/wp-content/uploads/2013/06/hm-logo-black-500.jpg" height="50px" width="70px" class="hm">
      <nav>
    ...
    <!-- ################################################################################################ -->
    <div class="group">
      <div class="one_third first" style="padding-left:90px; margin-right:50px;">
      ...
      <div class="one_third" style="margin-left:150px">
        <h6 class="heading">Newsletter</h6>
        <p class="nospace btmspace-30">For Regular Updates:</p>
